...
import com.xiaokun.xiusou.aidl.Bean.WebViewData;
import com.xiaokun.xiusou.aidl.FullListView.NestFullListView;
import com.xiaokun.xiusou.aidl.FullListView.NestFullListViewAdapter;
import com.xiaokun.xiusou.aidl.FullListView.NestFullViewHolder;
import com.xiaokun.xiusou.aidl.OKCallback.WebViewDataCallBack;
import com.xiaokun.xiusou.aidl.R;
import com.xiaokun.xiusou.aidl.Utils.ACache;
import com.xiaokun.xiusou.aidl.Utils.PicassoUtil;
...
//                        loadRecomend();
        ...
        NestFullListViewAdapter<WebViewData.recomends> nestFullListViewAdapter = new
                NestFullListViewAdapter<WebViewData.recomends>(R.layout.recomend_item, recomends)
                {
                    @Override
                    public void onBind(final int pos, WebViewData.recomends list, NestFullViewHolder holder)
                    {
