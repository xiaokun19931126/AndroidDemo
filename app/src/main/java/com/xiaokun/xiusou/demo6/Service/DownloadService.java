...
import com.xiaokun.xiusou.demo6.Activity.RetrofitDownLoadActivity;
import com.xiaokun.xiusou.demo6.Bean.Download;
...
public class DownloadService extends IntentService
{
    ...
    private void initDownload()
    {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(com.xiaokun.xiusou.demo6.Network.DownloadService.baseUrl)
                .build();

        com.xiaokun.xiusou.demo6.Network.DownloadService retrofitInterface = retrofit.create(com.xiaokun.xiusou.demo6.Network.DownloadService.class);
