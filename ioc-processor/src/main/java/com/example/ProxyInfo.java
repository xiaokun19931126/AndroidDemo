...
public class ProxyInfo
{
    ...
    public String generateJavaCode()
    {
        ...
        stringBuilder.append("// Generate code. Do not modify it !\n")
                ...
                .append("import com.xiaokun.ioc.*;\n\n")
                .append("public class ").append(mProxyClassName).append(" implements ")
                .append(SUFFIX).append("<").append(mTypeElement.getQualifiedName()).append(">").append("{\n");
